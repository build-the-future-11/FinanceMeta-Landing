type ExplainerCard = { id: string; slug: string; title: string; summary: string; difficulty: string; relatedTerms: string[]; body: string; [key: string]: unknown };
...
- [Investor.gov: Initial public offerings](https://www.investor.gov/introduction-investing/general-resources/news-alerts/alerts-bulletins/investor-bulletins-17)
...
- [Bank for International Settlements: monetary policy](https://www.bis.org/mc/compendium.htm)
